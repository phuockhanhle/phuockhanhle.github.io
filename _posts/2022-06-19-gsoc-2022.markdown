...
After experimenting, the model shows expected result. To evaluate the model, I use the evaluation set of AVA after labeling with classification. There are *14.702* images with *3.626* images from class 2 ( good images), *6.862* images from class 1 ( normal images), *4.214* images from class 1 ( bad images) The percentage of true prediction is 0.721. F1 score is 0.76457837 0.67457114 0.74173304 on each class. This [file][AVA-pred-file] shows the label and the prediction of each image of AVA dataset.
