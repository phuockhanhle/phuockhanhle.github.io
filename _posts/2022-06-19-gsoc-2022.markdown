...
As explained in the resume of last week, we can improve the model be combining different dataset. The main idea is create a most generalized datset. These experiments help us evaluate better the performance of the architecture. 
