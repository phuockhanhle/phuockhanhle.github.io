...
In the second task, I run Image Quality Sorter in two ways : normal way ( using 4 distortion detector ) and aesthetic detection. To compare calculation time, I run two ways on 5000 images. While the normal way takes 14 minutes to finish, the aesthetic detector takes only 8 minutes.
